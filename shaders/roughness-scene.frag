...
SDF map(vec3 p) {
    ...
    SDF s0;
    s0.distance = sdSphere(p - vec3(-0.6, -0.28, 0.0), 0.08);
    s0.id = 10.0;
    SDF s1;
    s1.distance = sdSphere(p - vec3(-0.4, -0.28, 0.0), 0.08);
    s1.id = 11.0;
    SDF s2;
    s2.distance = sdSphere(p - vec3(-0.2, -0.28, 0.0), 0.08);
    s2.id = 12.0;
    SDF s3;
    s3.distance = sdSphere(p - vec3(0.0, -0.28, 0.0), 0.08);
    s3.id = 13.0;
    SDF s4;
    s4.distance = sdSphere(p - vec3(0.2, -0.28, 0.0), 0.08);
    s4.id = 14.0;
    SDF s5;
    s5.distance = sdSphere(p - vec3(0.4, -0.28, 0.0), 0.08);
    s5.id = 15.0;
    SDF s6;
    s6.distance = sdSphere(p - vec3(0.6, -0.28, 0.0), 0.08);
    s6.id = 16.0;
